...
# ═══════════════════════════════════════════════════════════════════════════════
# 1.  FRONTIERE S&S  (Novikov-Thorne, formule esatte dal paper)
# ═══════════════════════════════════════════════════════════════════════════════

# import del modulo NT (stesso folder)
from ss_nt_boundaries import nt_boundaries, nt_mdot_from_Sigma0

def ss_boundaries(a, Sigma0, alpha=alpha_visc, M=M_BH):
    """
...
def compute_full_disk_profile(a, B00, Sigma0, alpha=0.01, M=M_BH,
...
def find_rossby_matches_SS(param_dict,  m, hr,
